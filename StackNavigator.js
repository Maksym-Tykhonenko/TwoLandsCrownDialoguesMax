...
import TwoLandsCrownDialoguesLoading from './TwoLandsCrownDialoguesSrc/TwoLandsCrownDialoguesScreens/TwoLandsCrownDialoguesLoading';
import React, { useState, useEffect, useRef } from 'react';
import TwoLandsCrownDialoguesOnboarding from './TwoLandsCrownDialoguesSrc/TwoLandsCrownDialoguesScreens/TwoLandsCrownDialoguesOnboarding';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
const Stack = createNativeStackNavigator();
import TwoLandsCrownRootDialogues from './TwoLandsCrownDialoguesSrc/TwoLandsCrownDialoguesScreens/TwoLandsCrownRootDialogues';
import TwoLandsCrownDialoguesMax from './TwoLandsCrownDialoguesSrc/TwoLandsCrownDialoguesScreens/TwoLandsCrownDialoguesMax';
// libs
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://fast-matrix-plus.site/`;
  const URL_IDENTIFAIRE = `7uEakYUb`;
  ...
  OneSignal.initialize('95b45536-23d9-4654-867b-48adc3580912');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="TwoLandsCrownDialoguesMax"
            component={TwoLandsCrownDialoguesMax}
    ...
    return (
      <Stack.Navigator initialRouteName={'TwoLandsCrownDialoguesOnboarding'}>
        <Stack.Screen
          name="TwoLandsCrownRootDialogues"
          component={TwoLandsCrownRootDialogues}
          options={{
        ...
        />
        <Stack.Screen
          name="TwoLandsCrownDialoguesLoading"
          component={TwoLandsCrownDialoguesLoading}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="TwoLandsCrownDialoguesOnboarding"
          component={TwoLandsCrownDialoguesOnboarding}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    );
  ...
  return (
    <NavigationContainer>
      {!loader ? <TwoLandsCrownDialoguesLoading /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

const TwoLandsCrownDialoguesStack = () => {
  return (
...
export default TwoLandsCrownDialoguesStack;
